...
class PublisherDetailScreen
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Издатель'),
      ),
      body: FutureBuilder<Publisher?>(
        future: context
            .read<PublisherRepository>()
            .findById(id),
...
class _PublisherCard extends StatelessWidget {
  ...
  Future<void> _restorePublisher(
      BuildContext context,
      ) async {
    await context
        .read<PublisherListNotifier>()
        .restoreItem(publisher.id);
  ...
  Future<void> _hardDeletePublisher(
      BuildContext context,
      ) async {
    final confirmed =
    await showDialog<bool>(
